...
export const CONTENT = {
  en: {
    ...
    education: {
      ...
      intro:
        "A formation shaped across engineering, AI and executive education. Developed across Europe, the Middle East and Latin America.",
      mapLabel: "Cities of study",
      cities: [
        {
          key: "barcelona",
          city: "Barcelona",
          ...
          lat: 41.3874,
          lon: 2.1686,
          descriptor: "Executive, technical and business formation anchored in Barcelona.",
          milestones: [
            "Executive MBA — ESADE Business School",
            "Postgraduate in Agile Project Management — IEBS Business School",
            "Master Degree in Big Data — Universidad de La Salle",
          ],
        },
        {
          key: "dubai",
          ...
          lat: 25.2048,
          lon: 55.2708,
          descriptor: "Executive immersion in global business transformation.",
          milestones: [
            "Executive MBA — International Immersion Week — American University in Dubai",
          ],
        },
        {
          key: "helsinki",
          ...
          lat: 60.1699,
          lon: 24.9384,
          descriptor: "Leadership and transformation in a Nordic innovation context.",
          milestones: [
            "Leading Change and Transformation — Aalto University",
          ],
        },
        {
          key: "tokyo",
          ...
          lat: 35.6762,
          lon: 139.6503,
          descriptor: "International executive exposure shaped by discipline, scale and global perspective.",
          milestones: [
            "Executive MBA — International Immersion Week — Globis Business School",
          ],
        },
        {
          key: "murcia",
          ...
          lat: 37.9922,
          lon: -1.1307,
          descriptor: "Advanced specialization in artificial intelligence.",
          milestones: [
            "Master Degree in Artificial Intelligence — UCAM",
          ],
        },
        {
          key: "lima",
          ...
          lat: -12.0464,
          lon: -77.0428,
          descriptor: "The engineering and analytics foundations of the journey.",
          milestones: [
            "Business Analytics and Big Data · Data Science — National University of Engineering",
            "Computing Systems Engineering — Universidad San Martín de Porres",
          ],
        },
      ],
    },
  ...
  es: {
    ...
    education: {
      ...
      intro:
        "Una formación construida entre ingeniería, IA y educación ejecutiva. Desarrollada entre Europa, Oriente Medio y Latinoamérica.",
      mapLabel: "Ciudades de formación",
      cities: [
        {
          key: "barcelona",
          city: "Barcelona",
          ...
          lat: 41.3874,
          lon: 2.1686,
          descriptor: "Formación ejecutiva, técnica y empresarial anclada en Barcelona.",
          milestones: [
            "Executive MBA — ESADE Business School",
            "Postgraduate in Agile Project Management — IEBS Business School",
            "Master Degree in Big Data — Universidad de La Salle",
        ...
        },
        {
          ...
          lat: 25.2048,
          lon: 55.2708,
          descriptor: "Inmersión ejecutiva en transformación empresarial global.",
          milestones: [
            "Executive MBA — International Immersion Week — American University in Dubai",
          ],
        },
        {
          ...
          lat: 60.1699,
          lon: 24.9384,
          descriptor: "Liderazgo y transformación en un contexto nórdico de innovación.",
          milestones: [
            "Leading Change and Transformation — Aalto University",
          ],
        },
        {
          ...
          lat: 35.6762,
          lon: 139.6503,
          descriptor: "Exposición ejecutiva internacional marcada por disciplina, escala y perspectiva global.",
          milestones: [
            "Executive MBA — International Immersion Week — Globis Business School",
          ],
        },
        {
          ...
          lat: 37.9922,
          lon: -1.1307,
          descriptor: "Especialización avanzada en inteligencia artificial.",
          milestones: [
            "Master Degree in Artificial Intelligence — UCAM",
          ],
        },
        {
          ...
          lat: -12.0464,
          lon: -77.0428,
          descriptor: "Los fundamentos de ingeniería y analítica del recorrido.",
          milestones: [
            "Business Analytics and Big Data · Data Science — National University of Engineering",
            "Computing Systems Engineering — Universidad San Martín de Porres",
          ],
