...
export const CONTENT = {
  en: {
    ...
    experience: {
      ...
      lead: "From BI and digital transformation to banking-grade AI architecture, my career has evolved around one constant: turning complex data ecosystems into governed, scalable and business-relevant systems.",
      controls: {
        selectorLabel: "Company selector",
        carouselLabel: "Selected experience showcase",
      ...
      items: [
        {
          ...
          wordmark: "NTT DATA",
          shortRole: "Chief AI",
          dateLocation: "2026 — Now · Barcelona",
          role: "Chief AI Architect",
          description: "Banking-grade AI, GenAI platforms, AWS lakehouse, governance and production-ready delivery.",
          tags: ["GenAI", "Banking", "AWS", "Governance", "Architecture"],
        },
        {
          company: "Capitole",
          wordmark: "Capitole",
          shortRole: "Practice",
          dateLocation: "2025 · Barcelona",
          role: "Head of Data & AI Practice",
          description: "Founded and scaled the Data & AI Practice across Iberia, shaping operating model, roadmap and alliances.",
          tags: ["Data & AI Practice", "Leadership", "Alliances", "AWS", "Snowflake"],
        },
        {
          company: "Kyndryl",
          wordmark: "Kyndryl",
          shortRole: "Data & AI",
          dateLocation: "2022 — 2025 · Barcelona",
          role: "Data & AI Lead",
          description: "Led AWS/GCP data architectures, lakehouse migrations, ML/AI blueprints, GenAI PoCs and team mentoring.",
          tags: ["AWS", "GCP", "Lakehouse", "ML/AI", "Data Engineering"],
        },
        {
          company: "Delosi",
          wordmark: "Delosi",
          shortRole: "Data Lead",
          dateLocation: "2021 — 2022 · Lima",
          role: "Data Lead",
          description: "Created the Data Analytics CoE and modernized AWS data, governance, customer analytics and ML capabilities.",
          tags: ["CoE", "AWS", "Data Lake", "Governance", "ML"],
        },
        {
          company: "Globant",
          wordmark: "Globant",
          shortRole: "Architect",
          dateLocation: "2021 · Lima",
          role: "Data Architect",
          description: "Designed AWS data architectures for advanced analytics, fraud detection and cloud migration initiatives.",
          tags: ["AWS", "Fraud Analytics", "Cloud Migration", "Data Architecture"],
        },
        {
          company: "Indra",
          wordmark: "Indra",
          shortRole: "Big Data",
          dateLocation: "2020 — 2021 · Lima",
          role: "Big Data Engineer Lead",
          description: "Contributed to BBVA's enterprise data platform across governance, Teradata, Spark and ingestion pipelines.",
          tags: ["Banking Data", "Spark", "Teradata", "Governance", "ETL"],
        },
        {
          company: "SEAT",
          wordmark: "SEAT",
          shortRole: "Big Data",
          dateLocation: "2019 · Barcelona",
          role: "Big Data Engineer",
          description: "Built Big Data and AI use cases for sentiment analysis, chatbots and connected-car data flows.",
          tags: ["Big Data", "Kafka", "Spark", "AWS", "Connected Car"],
        },
        {
          company: "Ourlimm",
          wordmark: "Ourlimm",
          shortRole: "BI Coach",
          dateLocation: "2018 — 2019 · Lima",
          role: "Power BI Data Analyst & Coach",
          description: "Trained business and IT users in Power BI, DAX, data modeling, visualization and SQL Server marts.",
          tags: ["Power BI", "DAX", "Data Modeling", "Coaching", "BI"],
        },
        {
          company: "ENGIE",
          wordmark: "ENGIE",
          shortRole: "Digital",
          dateLocation: "2017 — 2018 · Lima",
          role: "Digital Solution Analyst",
          description: "Supported digital transformation through analytics dashboards, IT service insights and Azure process automation.",
          tags: ["Digital Transformation", "Power BI", "Azure", "SAP", "Analytics"],
        },
      ],
    },
    domains: {
  ...
  es: {
    ...
    experience: {
      ...
      lead: "De BI y transformación digital a arquitectura de IA para banca: mi carrera ha evolucionado alrededor de una constante, convertir ecosistemas complejos de datos en sistemas gobernados, escalables y relevantes para el negocio.",
      controls: {
        selectorLabel: "Selector de compañías",
        carouselLabel: "Showcase de experiencia seleccionada",
        navigationLabel: "Navegación de experiencia",
        previous: "Compañía anterior",
        next: "Siguiente compañía",
      ...
      items: [
        {
          ...
          wordmark: "NTT DATA",
          shortRole: "Chief AI",
          dateLocation: "2026 — Hoy · Barcelona",
          role: "Chief AI Architect",
          description: "IA para banca, plataformas GenAI, lakehouse AWS, gobierno y delivery orientado a producción.",
          tags: ["GenAI", "Banca", "AWS", "Gobierno", "Arquitectura"],
        },
        {
          company: "Capitole",
          wordmark: "Capitole",
          ...
          dateLocation: "2025 · Barcelona",
          role: "Head of Data & AI Practice",
          description: "Fundó y escaló la práctica Data & AI en Iberia, definiendo modelo operativo, roadmap y alianzas.",
          tags: ["Data & AI Practice", "Liderazgo", "Alianzas", "AWS", "Snowflake"],
        },
        {
          company: "Kyndryl",
          wordmark: "Kyndryl",
          ...
          dateLocation: "2022 — 2025 · Barcelona",
          role: "Data & AI Lead",
          description: "Lideró arquitecturas AWS/GCP, migraciones lakehouse, blueprints ML/AI, PoCs GenAI y mentoría.",
          tags: ["AWS", "GCP", "Lakehouse", "ML/AI", "Data Engineering"],
        },
        {
          company: "Delosi",
          ...
          dateLocation: "2021 — 2022 · Lima",
          role: "Data Lead",
          description: "Creó el CoE de Data Analytics y modernizó datos AWS, gobierno, customer analytics y capacidades ML.",
          tags: ["CoE", "AWS", "Data Lake", "Gobierno", "ML"],
        },
        {
          company: "Globant",
          wordmark: "Globant",
          shortRole: "Arquitecto",
          dateLocation: "2021 · Lima",
          role: "Data Architect",
          description: "Diseñó arquitecturas AWS para analítica avanzada, detección de fraude y migración cloud.",
          tags: ["AWS", "Fraud Analytics", "Cloud Migration", "Data Architecture"],
        },
        {
          company: "Indra",
          ...
          dateLocation: "2020 — 2021 · Lima",
          role: "Big Data Engineer Lead",
          description: "Contribuyó a la plataforma enterprise de BBVA en gobierno, Teradata, Spark e ingesta de datos.",
          tags: ["Banking Data", "Spark", "Teradata", "Gobierno", "ETL"],
        },
        {
          company: "SEAT",
          wordmark: "SEAT",
          ...
          dateLocation: "2019 · Barcelona",
          role: "Big Data Engineer",
          description: "Construyó casos Big Data e IA para sentiment analysis, chatbots y flujos connected-car.",
          tags: ["Big Data", "Kafka", "Spark", "AWS", "Connected Car"],
        },
        {
          company: "Ourlimm",
          ...
          dateLocation: "2018 — 2019 · Lima",
          role: "Power BI Data Analyst & Coach",
          description: "Formó a usuarios de negocio e IT en Power BI, DAX, modelado, visualización y marts SQL Server.",
          tags: ["Power BI", "DAX", "Data Modeling", "Coaching", "BI"],
        },
        {
          company: "ENGIE",
          ...
          dateLocation: "2017 — 2018 · Lima",
          role: "Digital Solution Analyst",
          description: "Impulsó transformación digital con dashboards, analítica de servicios IT y automatización Azure.",
          tags: ["Transformación Digital", "Power BI", "Azure", "SAP", "Analytics"],
        },
      ],
    },
    domains: {
